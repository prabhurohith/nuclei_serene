...
public enum AppPages {
    ...
    DETAILS_PAGE(getPages().getPage(DetailsPage.class), Constants.DETAILS_PAGE),
    ...
    public static List<AppPages> getAllPages() {
        return new ArrayList<AppPages>(List.of(LOGIN_PAGE, HOME_PAGE,DRAWING_PAGE,LEFT_NAVIGATION_PAGE,DETAILS_PAGE));
    }
